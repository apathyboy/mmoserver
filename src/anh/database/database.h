...
public:
    ...
    */
    Database(DatabaseManager* database_manager, DBType type, const std::string& host, uint16_t port, const std::string& user, const std::string& pass, const std::string& schema, DatabaseConfig& config);
    ~Database();
    ...
    * 
    */
    void executeAsyncSql(const std::stringstream& sql, DatabaseCallback callback);
    ...
    */
    void executeAsyncSql(const std::string& sql, DatabaseCallback callback);
    ...
    * \param callback The callback to invoke once the sql query has been executed.
    */
    void executeAsyncProcedure(const std::stringstream& sql, DatabaseCallback callback);
    ...
    * \param callback The callback to invoke once the sql query has been executed.
    */
    void executeAsyncProcedure(const std::string& sql, DatabaseCallback callback);
    ...
    */
    Transaction* startTransaction(DatabaseCallback callback);
