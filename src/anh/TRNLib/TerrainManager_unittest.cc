...
TEST(TerrainManagerTest, getWaterHeight) {
	// Construct a terrain manager for Tattooine.
	TRNLib::TerrainManager tm_test("../../bin/Debug/terrain/tatooine.trn");
	...
	EXPECT_EQ(0, header->use_global_water_height) << "Expected use_global_water_height of 0";
	EXPECT_EQ(0, header->global_water_height) << "Expected global_water_height of 0";
}

TEST(TerrainManagerTest, getHeight) {
