 ...
 */
class PingServer : public anh::BaseApplication
{
public:
     ...
     */
    explicit PingServer(int argc, char* argv[], std::list<std::string> config_files
        , std::shared_ptr<anh::event_dispatcher::IEventDispatcher> dispatcher);
